...
# Generador
    ...
    def generar_anuncio(datos):
        ...
        - Adaptarse al canal:
          - Si el destino es "portales inmobiliarios", escribe con estilo profesional y estructurado, orientado a SEO y con llamadas a la acción claras, el anuncio tiene que tener un maximo de 850 caracteres con los espacios y sin emojis.
          - Si el destino es "redes sociales", usa un estilo más directo, emocional, con emojis (donde encajen), y termina con hashtags relevantes según el país o ciudad, el anuncio tiene que tener un maximo de 600 caracteres con espacios.
