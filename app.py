...
# Generador
    ...
    def generar_anuncio(datos):
        ...
        - Adaptarse al canal:
          - Si el destino es "portales inmobiliarios", escribe con estilo profesional y estructurado, orientado a SEO y con llamadas a la acción claras. La Longitud maxima del anuncio tiene que ser de 850 caracteres contando los espacios entre palabras.
